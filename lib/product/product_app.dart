...
class _ProductAppState extends State<ProductApp> {
  final ChoiceStore _store = ChoiceStore();
  int _tab = 0;
...
class _BottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      (icon: Icons.casino_rounded, label: 'Режимы'),
      (icon: Icons.add_circle_outline_rounded, label: 'Создать'),
      (icon: Icons.format_list_bulleted_rounded, label: 'Списки'),
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      items[i].icon,
                      size: 22,
                      color: i == index ? Colors.black : AppTheme.textMuted,
                    ),
